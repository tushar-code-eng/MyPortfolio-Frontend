            ...
            content: (
                <div>
                    <div className="trigger1 grid grid-cols-2 gap-4 group/card ">
                        ...
                        <div className=" hidden first p-3 md:flex justify-center items-center text-neutral-500 rounded-lg object-cover md:h-44 lg:h-60 w-full">
                            <p>
                        ...
                        <div className="hidden first md:flex p-3 justify-center items-center text-neutral-500 rounded-lg object-cover text-sm md:h-44 lg:h-60 w-full">
                            <p>
            ...
            content: (
                <div>
                    ...
                    <div className="trigger3 grid grid-cols-2 gap-4 group/card">
                        ...
                        <div className="third hidden md:flex justify-center p-3 items-center text-neutral-500 rounded-lg object-cover max-h-20 md:max-h-44 lg:h-60 w-full">
                            <p>
                        ...
                        <div className="third hidden md:flex justify-center p-3 items-center text-neutral-500 rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full">
                            <p>
            ...
            content: (
                <div>
                    ...
                    <div className=" trigger4 grid grid-cols-2 gap-4 group/card">
                        ...
                        <div className="four hidden md:flex p-3 justify-center items-center text-neutral-500 rounded-lg object-cover max-h-20 md:max-h-44 lg:h-60 w-full">
                            <p>
                        ...
                        <div className="four hidden md:flex p-3 justify-center items-center text-neutral-500 rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full">
                            <p>
