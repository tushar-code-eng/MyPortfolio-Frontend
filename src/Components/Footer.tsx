    ...
    <div className="overflow-hidden w-[80%] m-auto bg-white border-2">
      <div className="my-6 lg:my-12 flex items-center justify-between overflow-hidden mx-2 lg:mx-10">
        ...
        <div className=" flex justify-end items-center gap-4 ">
          ...
          <div onClick={scrollToTop} className="w-12 cursor-pointer z-10 ">
            <img src={top} alt="" />
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden w-full flex flex-col gap-7 mt-4">
        <div className="flex flex-wrap w-full items-center justify-around">
          <div
            onClick={() =>
              window.open("https://github.com/tushar-code-eng", "_blank")
            }
        ...
        <div className="flex flex-wrap w-full items-center justify-around">
          <div
            onClick={() =>
              window.open("https://www.instagram.com/tushar_bajaj05/", "_blank")
            }
            className=" flex items-center justify-center gap-2 p-2 rounded-md"
          >
            Instagram{" "}
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.linkedin.com/in/tushar-bajaj-6b7675246",
                "_blank"
              )
            }
            className=" flex items-center justify-center gap-2 p-2 rounded-md"
      ...
      <div className="hidden py-10 w-full lg:flex items-center justify-around px-10 ">
        ...
        >
          <div className="underlineParent hover-bg-drop text-lg pr-40 pt-2 pb-16 w-full">
